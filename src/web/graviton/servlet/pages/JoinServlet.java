...
public class JoinServlet extends HttpServlet {
    private final static String NAME = "Nous rejoindre";
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.setAttribute("headerData", HtmlGenerator.generateHeader((byte) 2, account != null));
        ...
        this.getServletContext().getRequestDispatcher("/WEB-INF/joinus.jsp").forward(request, response);
    }
