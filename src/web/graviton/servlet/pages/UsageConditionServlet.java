 ...
 */
public class UsageConditionServlet extends HttpServlet {
    private final static String NAME = "C.G.U";
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        this.getServletContext().getRequestDispatcher("/WEB-INF/cgu.jsp").forward(request, response);
    }
